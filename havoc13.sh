...
start_build_process() {
    ...
    repo init -u https://github.com/Havoc-OS/android_manifest.git -b thirteen --git-lfs --depth=1

mkdir -p .repo/local_manifests
cat > .repo/local_manifests/havoc_mms_download_override.xml << 'EOF'
<?xml version="1.0" encoding="UTF-8"?>
<manifest>
  <remove-project name="LineageOS/android_packages_services_Mms" />
  <project name="Havoc-OS/android_packages_services_Mms" path="packages/services/Mms" remote="github" revision="twelve" />

  <remove-project name="LineageOS/android_packages_providers_DownloadProvider" />
  <project name="Havoc-OS/android_packages_providers_DownloadProvider" path="packages/providers/DownloadProvider" remote="github" revision="twelve" />
</manifest>
EOF
...
#clone dt
git clone https://github.com/LineageOS/android_kernel_sony_sdm845 -b lineage-20 kernel/sony/sdm845
    git clone https://github.com/Sorayukii/android_device_sony_apollo -b 13 device/sony/apollo
    ...
    git clone https://github.com/Sorayukii/proprietary_vendor_sony_apollo -b 13 vendor/sony/apollo
    git clone https://github.com/Sorayukii/proprietary_vendor_sony_tama-common -b 13 vendor/sony/tama-common

touch external/chromium-webview/patches/Android.mk
touch external/chromium-webview/patches/CleanSpec.mk

sed -i 's/tama_apollo_dcm_defconfig/tama_apollo_defconfig/g' device/sony/apollo/BoardConfig.mk
rm -rf out/target/product/apollo/obj/KERNEL_OBJ

sed -i '/hal_turbo_adapter_hwservice/d' device/lineage/sepolicy/common/vendor/platform_app.te
sed -i '/hal_turbo_adapter_hwservice/d' device/lineage/sepolicy/common/vendor/hwservice_contexts
