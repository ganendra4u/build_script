...
start_build_process() {
    ...
    repo init -u https://github.com/ProjectMatrixx/android -b 16.2 --git-lfs --depth=1
    ...
    git clone https://github.com/ganendra4u/android_device_sony_"$DEVICE_CODE" -b matrixx-16.2 device/sony/"$DEVICE_CODE"
    ...
    make matrixx 2>1 | tee error.log
