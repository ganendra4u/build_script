...
cd -
    ...
    git clone https://github.com/ganendra4u/android_device_sony_"$DEVICE_CODE" -b infinity-16.2 --depth=1 device/sony/"$DEVICE_CODE"
    ...
    . build/envsetup.sh
    lunch infinity_"$DEVICE_CODE"-user
